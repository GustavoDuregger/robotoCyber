...
class RoboTerrestreNovoScreen extends StatefulWidget {
  @override
  _RoboTerrestreNovoScreenState createState() => _RoboTerrestreNovoScreenState();
}

class _RoboTerrestreNovoScreenState extends State<RoboTerrestreNovoScreen> {
  final GlobalKey<FormState> formKey = new GlobalKey<FormState>();
  final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();

  RoboTerrestreModel roboModel = new RoboTerrestreModel();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Criar Robô Terrestre"),
      ),
      body: Padding(
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () {
                        if (formKey.currentState.validate()) {
                          ...
                          new RoboTerrestreService().create(roboModel);
