...
class DroneDetalhesScreen extends StatefulWidget {
  @override
  _DroneDetalhesScreenState createState() => _DroneDetalhesScreenState();
}

class _DroneDetalhesScreenState extends State<DroneDetalhesScreen> {
  
    RoboDroneModel roboModel;
              ...
              child: RaisedButton(
                ...
                onPressed: () async {
                  ...
                  if (retorno != null) {
                    ...
                    roboModel = retorno as RoboDroneModel;
