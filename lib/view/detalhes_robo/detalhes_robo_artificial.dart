...
class ArtificialDetalhesScreen extends StatefulWidget {
  @override
  _ArtificialDetalhesScreenState createState() => _ArtificialDetalhesScreenState();
}

class _ArtificialDetalhesScreenState extends State<ArtificialDetalhesScreen> {
  
    RoboArtificialModel roboModel;
              ...
              child: RaisedButton(
                ...
                onPressed: () async {
                  ...
                  if (retorno != null) {
                    ...
                    roboModel = retorno as RoboArtificialModel;
