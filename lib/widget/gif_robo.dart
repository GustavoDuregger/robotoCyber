    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          Text("Sucesso!!!", style:TextStyle(color: Colors.deepPurpleAccent[400], fontSize: 30),),
          new Padding(
                                    padding: new EdgeInsets.only(
                                      top: 15,
                                    ),
                                  ),
          Text("Seu robô já entrou na linha de produção e deve estar pronto em breve",textAlign: TextAlign.center, style:TextStyle(color: Colors.white70, fontSize: 20),),
          new Padding(
                                    padding: new EdgeInsets.only(
                                      top: 35,
                                    ),
