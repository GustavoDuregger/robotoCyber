...
import 'package:roboto/view/detalhes_robo/detalhes_robo_terrestre.dart';
...
import 'view/detalhes_robo/detalhes_robo_artificial.dart';
import 'view/detalhes_robo/detalhes_robo_drone_screen.dart';
import 'view/detalhes_robo/treinarcognicao_artificial.dart';
import 'view/detalhes_robo/treinarcognicao_drone_view.dart';
import 'view/detalhes_robo/treinarcognicao_terrestre.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/detalhesroboterrestre':(context)=>TerrestreDetalhesScreen(),
        '/detalhesroboartificial':(context)=>ArtificialDetalhesScreen(),
        '/treinardrone':(context)=>TreinarDroneScreen(),
        '/sucessotreinamento':(context)=>AnimacaoTreinamento(),
        '/treinarterrestre':(context)=>TreinarTerrestreScreen(),
        '/treinarartificial':(context)=>TreinarArtificialScreen()
      });
  }
}