...
class RoboTerrestreModel {
  ...
  factory RoboTerrestreModel.fromJson(String str) =>
      RoboTerrestreModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory RoboTerrestreModel.fromMap(Map<String, dynamic> json) => RoboTerrestreModel(
        id: json["id"],
        nome: json["nome"],
